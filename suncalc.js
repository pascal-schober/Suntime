// SunCalc — https://github.com/mourner/suncalc  (MIT License)
// Adapted to expose a global SunCalc object for use as a plain <script>.
...
(function (global) {
    ...
    SunCalc.getTimes = function (date, lat, lng, height) {
        ...
        for (const time of SunCalc.times) {
    ...
    SunCalc.getMoonTimes = function (date, lat, lng, inUTC) {
        ...
        for (let i = 1; i <= 24; i += 2) {
            ...
            if (d2 >= 0) {
                const dx = Math.sqrt(d2) / (Math.abs(a) * 2);
                x1 = xe - dx;
                x2 = xe + dx;
